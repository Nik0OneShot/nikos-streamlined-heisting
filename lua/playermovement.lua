...
Hooks(PostHook, "on_SPOOCed", "cuff_cloakers", function(self)
    if self._current_state_name == "standard" or self._current_state_name == "bleed_out" or self._current_state_name == "carry" or self._current_state_name == "tased" or self._current_state_name == "bipod" or ~= pro_job then
